...
"%exePath%" -e "%reportPath%SerialNumberList_v2.rpt" "Parm1:%orderNum%" "Export_Format:Printer (Specified)" "Export_File:%printerName%" "Print_Copies:%printNum%" "Use_Saved_Data_Recent:5"

goto :config
:assy &:: this is for parts that are assemblys, which dont have a assembly number
"%exePath%" -e "%reportPath%SerialNumberList_v3.rpt" "Parm1:%orderNum%" "Export_Format:Printer (Specified)" "Export_File:%printerName%" "Print_Copies:%printNum%" "Use_Saved_Data_Recent:5"
